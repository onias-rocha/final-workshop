...
public class Examples {
    ...
    public static void testInstanceof(Object pessoa){
        ...
        // modo novo
        if (pessoa instanceof Pessoa novaPessoa){
            System.out.println(novaPessoa.nome);
        }
    }

    public static void testInstanceofJava15(Object pessoa){
        // modo antigo
        if (pessoa instanceof Pessoa){
            Pessoa novaPessoa = (Pessoa) pessoa;
        }
        ...
        // modo novo
        if (pessoa instanceof Pessoa novaPessoa && novaPessoa.idade > 18){
            System.out.println(novaPessoa.nome + " is allowed in the club");
        } else {
